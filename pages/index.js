...
const Index = ({
  ...
  const head = () => (
    <Head>
      <title>Connecting the Nagas | {APP_NAME}</title>
      <meta
        name="description"
        content="Lifestyles, news, politics, updates, stories and folktales of the Naga tribes. Know all about the Nagas and more here."
      />
      <link rel="canonical" href={`${DOMAIN}${router.pathname}`} />
      <meta
        property="og:title"
        content={`Know more about the Nagas here. | ${APP_NAME}`}
      />
      <meta
